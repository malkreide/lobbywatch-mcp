...
from lobbywatch_mcp.__main__ import CORS_ROUTING_HEADERS, build_asgi_app
...
def client(monkeypatch: pytest.MonkeyPatch) -> TestClient:
    monkeypatch.setenv("LOBBYWATCH_MCP_CORS_ORIGINS", ORIGIN)
    return TestClient(build_asgi_app("http"))
...
def test_die_methodenliste_nennt_die_sessionbeendigung() -> None:
    ...
    from lobbywatch_mcp.__main__ import CORS_ALLOW_METHODS
